...
namespace ResidualKnowledgeTestApp.Client.Services
{
    public class CheckingDisciplinesService : ICheckingDisciplinesService
    {
        ...
        public CheckingDisciplinesService(HttpClient httpClient)
        {
        ...
        {
            var _ = (UserChoice, Curriculum, CheckingDisciplines, DisciplinesForSelection, SelectedCompetences); // do it on server
            await _httpClient.GetStringAsync(""); // сверить код с Ульяниным!
