...
namespace ResidualKnowledgeApp.ContingentParser
{
    /// <summary>
    ...
    public class Contingent : IEnumerable<Student>
    {
        ...
        private static string ParseProgrammeCode(string line)
        {
        ...
        private static string ParseCurriculumCode(string line)
        {
